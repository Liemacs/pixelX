   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<div class="dtp-close"><a href="javascript:void(0);"><i class="fa-solid fa-x"></i></</div>' +
                         '</header>' +
                         '<div class="dtp-date hidden">' +
                         '<div>' +
                         '<div class="left center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-month-before"><i class="fa-solid fa-angle-left"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-month p80">MAR</div>' +
                         '<div class="right center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-month-after"><i class="fa-solid fa-angle-right"></i></a>' +
                         '</div>' +
                         ...
                         '<div>' +
                         '<div class="left center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-year-before"><i class="fa-solid fa-angle-left"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-year p80">2014</div>' +
                         '<div class="right center p10">' +
                         '<a href="javascript:void(0);" class="dtp-select-year-after"><i class="fa-solid fa-angle-right"></i></a>' +
                         '</div>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
              ...
              initHours: function ()
              {
                 ...
                 for (var i = 0; i < 12; i++)
                 {
                    ...
                    var fill = ((this.currentDate.format(hFormat) == i) ? "#17302e" : 'transparent');
