...
function setSkinListHeightAndScroll() {
    var a =
        ...
        b = $(".demo-choose-skin");
    b.slimScroll({ destroy: !0 }).height("auto"),
        b.parent().find(".slimScrollBar, .slimScrollRail").remove(),
        b.slimscroll({
            height: a + "px",
        ...
        activate: function () {
            $(".form-control").focus(function () {
                ...
                $(".form-control").focusout(function () {
                    var a = $(this);
                    a.parents(".form-group").hasClass("form-float")
                        ? "" == a.val() &&
                          a.parents(".form-line").removeClass("focused")
                        : a.parents(".form-line").removeClass("focused");
                }),
                $("body").on(
                    "click",
